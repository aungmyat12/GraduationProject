...
<head>
    ...
    <title>《ログイン》 KIDDA-LA 業務システム</title>
    ...
    <main class="container">
        <div class="row">
            <div class="offset-1 col-10 d-flex flex-column">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="email" name="email"
                                           ...
                                           value="<%= userInput != null ? userInput.getEmail() : "" %>"
                                           required>
                ...
                <form action="KiddaLaController" method="post">
				    <input type="hidden" name="command" value="GoogleLogin">
				    <button type="submit" class="btn btn-google btn-lg w-100 rounded-pill fs-5 d-flex align-items-center justify-content-center mb-3">
