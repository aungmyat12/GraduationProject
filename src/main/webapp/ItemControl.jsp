...
<div class="card-body bg-warning-subtle text-start">
    <div class="row mb-1">
        ...
        <div class="col-10">
            <input class="<%= (item != null && !"add".equals(mode)) ? "form-control-plaintext" : "form-control" %> fs-5" id="itemId" name="itemId" type="text" value="<%= item != null ? item.getItemId() : "" %>" <%= (item != null && !"add".equals(mode)) ? "readonly" : "" %>>
        </div>
    </div>
    <div class="row mb-1">
            ...
            <% for(String[] i : itemData) { %>
                <tr>
                    ...
                    <td class="p-0 align-middle">
					    <!-- 編集ボタン -->
					    <a href="KiddaLaController?command=ItemControlDisplay&mode=edit&itemId=<%= i[0] %>" class="btn btn-success btn-sm">
